...
const { buildRecommendation, toVisitorRecommendation } = require('../lib/starter-assessment/recommendation.cjs');
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const { data: lead, error } = await supabase
      ...
      .select('id, result_token_expires_at, primary_goal, desired_result, training_environment, training_days, main_barrier, nutrition_support, starting_timeline, support_preference, whatsapp, marketing_whatsapp_consent')
