...
(function () {
  ...
  auto_calculated: "Calculado automaticamente",
      ...
      guarantee: {
        ...
        "support.desc": "Acesso pelo chat do app para dúvidas a qualquer hora",
      ...
      hero: {
        p: "Treino preciso, nutrição simples e responsabilidade implacável — 100% online via Trainerize e o chat do app."
      },
      cta: {
        start: "Começar Hoje",
        plans: "Ver Planos",
        strip: {
          ...
          p: "Agende uma consulta gratuita ou me envie uma mensagem no Instagram. Atendo em PT/EN/ES.",
      ...
      about: {
        ...
        accountability: { title: "Responsabilidade", p: "Check-ins diretos via chat do app para te manter consistente." },
    ...
    es: {
      ...
      video: {
        ...
        point3: "Soporte 24/7 por chat de la app",
      ...
      guarantee: {
        ...
        "support.desc": "Acceso por chat de la app para preguntas en cualquier momento",
      ...
      hero: {
        p: "Entrenamiento preciso, nutrición simple y responsabilidad implacable — 100% online vía Trainerize y el chat de la app."
      },
      cta: {
        start: "Empezar Hoy",
        plans: "Ver Planes",
