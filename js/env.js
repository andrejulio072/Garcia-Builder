...
(function loadSupabasePublicEnv() {
    ...
    const normalizeEnv = (data) => {
        ...
        const env = {
            ...
            NEXT_PUBLIC_BOOKING_URL: typeof data.NEXT_PUBLIC_BOOKING_URL === 'string' ? data.NEXT_PUBLIC_BOOKING_URL.trim() : '',
            NEXT_PUBLIC_WHATSAPP_NUMBER: typeof data.NEXT_PUBLIC_WHATSAPP_NUMBER === 'string' ? data.NEXT_PUBLIC_WHATSAPP_NUMBER.trim() : '',
            NEXT_PUBLIC_INSTAGRAM_URL: typeof data.NEXT_PUBLIC_INSTAGRAM_URL === 'string' ? data.NEXT_PUBLIC_INSTAGRAM_URL.trim() : '',
            NEXT_PUBLIC_CONTACT_EMAIL: typeof data.NEXT_PUBLIC_CONTACT_EMAIL === 'string' ? data.NEXT_PUBLIC_CONTACT_EMAIL.trim() : '',
    ...
    const mirrorEnv = (env) => {
        ...
        window.NEXT_PUBLIC_BOOKING_URL = env.NEXT_PUBLIC_BOOKING_URL || window.NEXT_PUBLIC_BOOKING_URL;
        window.NEXT_PUBLIC_WHATSAPP_NUMBER = env.NEXT_PUBLIC_WHATSAPP_NUMBER || window.NEXT_PUBLIC_WHATSAPP_NUMBER;
        window.NEXT_PUBLIC_INSTAGRAM_URL = env.NEXT_PUBLIC_INSTAGRAM_URL || window.NEXT_PUBLIC_INSTAGRAM_URL;
        window.NEXT_PUBLIC_CONTACT_EMAIL = env.NEXT_PUBLIC_CONTACT_EMAIL || window.NEXT_PUBLIC_CONTACT_EMAIL;
    ...
    const existingGlobals = normalizeEnv({
        ...
        NEXT_PUBLIC_BOOKING_URL: window.NEXT_PUBLIC_BOOKING_URL,
        NEXT_PUBLIC_WHATSAPP_NUMBER: window.NEXT_PUBLIC_WHATSAPP_NUMBER,
        NEXT_PUBLIC_INSTAGRAM_URL: window.NEXT_PUBLIC_INSTAGRAM_URL,
        NEXT_PUBLIC_CONTACT_EMAIL: window.NEXT_PUBLIC_CONTACT_EMAIL
    });
    if (existingGlobals) {
