...
(function loadSupabasePublicEnv() {
    ...
    const normalizeEnv = (data) => {
        ...
        const env = {
            ...
            NEXT_PUBLIC_TURNSTILE_SITE_KEY: typeof data.NEXT_PUBLIC_TURNSTILE_SITE_KEY === 'string' ? data.NEXT_PUBLIC_TURNSTILE_SITE_KEY.trim() : '',
    ...
    const mirrorEnv = (env) => {
        ...
        window.NEXT_PUBLIC_TURNSTILE_SITE_KEY = env.NEXT_PUBLIC_TURNSTILE_SITE_KEY || window.NEXT_PUBLIC_TURNSTILE_SITE_KEY;
    ...
    const existingGlobals = normalizeEnv({
        ...
        NEXT_PUBLIC_TURNSTILE_SITE_KEY: window.NEXT_PUBLIC_TURNSTILE_SITE_KEY
    });
    if (existingGlobals) {
