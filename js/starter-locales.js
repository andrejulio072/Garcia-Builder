(function (root, factory) {
  ...
  const UI = {
    en: {
      ...
      resultTitleLoading: 'Loading your result…', resultSummaryLoading: 'Please wait while we open your recommended starting plan.',
    ...
    pt: {
      ...
      resultTitleLoading: 'Carregando seu resultado…', resultSummaryLoading: 'Aguarde enquanto abrimos o seu plano inicial recomendado.',
    ...
    es: {
      ...
      resultTitleLoading: 'Cargando tu resultado…', resultSummaryLoading: 'Espera mientras abrimos tu plan inicial recomendado.',
