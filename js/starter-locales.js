(function (root, factory) {
  ...
  const UI = {
    en: {
      ...
      heroCopyPaid: 'Answer seven quick questions about your goal, routine and biggest challenge. Get a practical workout and nutrition starting point, plus the option to discuss a fully tailored plan with Andre.',
      ...
      signalOneCopy: 'Questions adapt your starting structure in minutes.',
      signalTwoTitle: 'Multi-channel support',
      signalTwoCopy: 'Choose the easiest way for Andre to follow up.',
      signalThreeTitle: 'Fast, practical, actionable',
      signalThreeCopy: 'Clear next steps you can start this week.',
      ...
      validInstagram: 'Instagram profile is too long.',
    ...
    pt: {
      ...
      heroCopyPaid: 'Responda sete perguntas rápidas sobre o seu objetivo, rotina e principal dificuldade. Receba um ponto de partida prático para treino e nutrição, com a opção de conversar com Andre sobre um plano totalmente personalizado.',
      ...
      signalOneCopy: 'As perguntas ajustam a estrutura inicial em minutos.',
      signalTwoTitle: 'Suporte multicanal',
      signalTwoCopy: 'Escolha o canal mais fácil para Andre fazer follow-up.',
      signalThreeTitle: 'Rápido, prático e acionável',
      signalThreeCopy: 'Próximos passos claros para começar nesta semana.',
      ...
      validInstagram: 'O perfil do Instagram está muito longo.',
    ...
    es: {
      ...
      heroCopyPaid: 'Responde siete preguntas rápidas sobre tu objetivo, rutina y principal dificultad. Recibe un punto de partida práctico de entrenamiento y nutrición, con la opción de hablar con Andre sobre un plan totalmente personalizado.',
      ...
      signalOneCopy: 'Las preguntas ajustan tu estructura inicial en minutos.',
      signalTwoTitle: 'Soporte multicanal',
      signalTwoCopy: 'Elige el canal más fácil para que Andre haga seguimiento.',
      signalThreeTitle: 'Rápido, práctico y accionable',
      signalThreeCopy: 'Próximos pasos claros para empezar esta semana.',
      ...
      validInstagram: 'El perfil de Instagram es demasiado largo.',
