(function (root, factory) {
  ...
  const UI = {
    en: {
      ...
      coachProofBody: 'I coach with the same method I live: structured training, practical nutrition and disciplined execution. Your first free starter plan is built from that proven system, adapted to your reality.',
    ...
    pt: {
      ...
      coachProofBody: 'Eu coacho com o mesmo método que vivo: treino estruturado, nutrição prática e execução disciplinada. O seu primeiro plano inicial gratuito nasce desse sistema comprovado, adaptado à sua realidade.',
    ...
    es: {
      ...
      coachProofBody: 'Entreno y coacho con el mismo método que vivo: entrenamiento estructurado, nutrición práctica y ejecución disciplinada. Tu primer plan inicial gratuito nace de ese sistema probado, adaptado a tu realidad.',
