(function (root, factory) {
  ...
  const UI = {
    en: {
      ...
      coachProofBody: 'I coach from real execution: structured training, practical nutrition and repeatable habits. The same framework I apply to myself is the one I use to build your first free starter plan.',
    ...
    pt: {
      ...
      coachProofBody: 'Eu coacho com execução real: treino estruturado, nutrição prática e hábitos repetíveis. A mesma estrutura que aplico em mim é a que uso para montar o seu primeiro plano inicial gratuito.',
    ...
    es: {
      ...
      coachProofBody: 'Entreno y coacho desde ejecución real: entrenamiento estructurado, nutrición práctica y hábitos repetibles. El mismo marco que aplico en mí es el que uso para construir tu primer plan inicial gratuito.',
