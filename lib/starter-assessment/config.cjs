const CONSENT_COPY_VERSION = 'starter-assessment-2026-07-11';
...
const QUESTIONS = [
  ...
  {
    id: 'desired_result',
    text: 'Which result would make the biggest difference to you?',
    options: [
      'Feel more confident in my body',
      'Lose weight and reduce my waist',
      'Look leaner and more defined',
      'Build strength and muscle',
      'Improve fitness and energy',
      'Create a routine I can maintain'
    ]
  },
  {
