const workoutUrl = (slug) => `/workouts.html#workout-${slug}`;

const WORKOUT_RESOURCE_SLUG_BY_TITLE = {
  'Two-Day Full-Body Starter': 'low-impact-rebuild',
  'Three-Day Full-Body Strength and Fat-Loss Template': 'lose-weight-starter',
  'Four-Day Upper/Lower Template': 'gym-upper-lower-builder',
  'Five-Day Structured Gym Template': 'strength-and-conditioning-pro',
  'Home Dumbbell Training Template': 'home-dumbbell-progression',
  'Bodyweight Consistency Starter': 'home-bodyweight-beginner',
  'Hybrid Training Starter': 'hybrid-engine-builder',
  'Two-Day Rebuild Programme': 'low-impact-rebuild'
};

function getWorkoutLibraryUrl(title) {
  const slug = WORKOUT_RESOURCE_SLUG_BY_TITLE[title];
  return slug ? workoutUrl(slug) : '/workouts.html#workout-library';
}
...
const RESOURCE_CATALOGUE = [
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Two-Day Full-Body Starter'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Three-Day Full-Body Strength and Fat-Loss Template'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Four-Day Upper/Lower Template'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Five-Day Structured Gym Template'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Home Dumbbell Training Template'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Bodyweight Consistency Starter'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Hybrid Training Starter'),
  ...
  },
  {
    ...
    type: 'workout',
    url: getWorkoutLibraryUrl('Two-Day Rebuild Programme'),
