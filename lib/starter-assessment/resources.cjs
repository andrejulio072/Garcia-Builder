const RESOURCE_CATALOGUE = [
  ...
  },
  {
    ...
    type: 'workout',
    url: '/blog-home-workouts-busy.html',
    actionLabel: 'Open Home Training Guide',
    downloadFilename: null,
    available: true
  },
  {
    ...
    type: 'workout',
    url: '/blog-consistency.html',
    actionLabel: 'Open Consistency Guide',
    downloadFilename: null,
    available: true
  },
  {
  ...
  },
  {
    ...
    type: 'workout',
    url: '/blog-strength-beginners.html',
    actionLabel: 'Open Rebuild Training Guide',
    downloadFilename: null,
    available: true
  },
  {
    ...
    type: 'nutrition',
    url: '/blog-protein-meal-prep.html',
    actionLabel: 'Open High-Protein Meal Guide',
    downloadFilename: null,
    available: true
  },
  {
  ...
  },
  {
    ...
    type: 'nutrition',
    url: '/blog-protein-meal-prep.html',
    actionLabel: 'Open Protein Food Ideas',
    downloadFilename: null,
    available: true
  },
  {
    ...
    type: 'nutrition',
    url: '/blog-fat-loss-nutrition.html',
    actionLabel: 'Open Portion Guide',
    downloadFilename: null,
    available: true
  },
  {
    ...
    type: 'nutrition',
    url: '/blog-protein-meal-prep.html',
    actionLabel: 'Open Meal Prep Template',
    downloadFilename: null,
    available: true
  },
  {
    ...
    type: 'nutrition',
    url: '/blog-stress-eating-control.html',
    actionLabel: 'Open Cravings Guide',
    downloadFilename: null,
    available: true
  },
  {
