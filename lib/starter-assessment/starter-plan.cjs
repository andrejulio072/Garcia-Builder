const CALCULATOR_URL = '/nutrition-calculator';
const NUTRITION_LIBRARY_URL = '/nutrition-calculator';
const { getWorkoutLibraryUrl } = require('./resources.cjs');
...
function buildStarterPlan(answers, recommendation) {
  ...
  return {
    ...
    training: {
      ...
      libraryUrl: getWorkoutLibraryUrl(recommendation.workoutTemplate)
    },
    nutrition: {
