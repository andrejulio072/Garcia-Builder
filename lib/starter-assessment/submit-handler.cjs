  ...
  const quickStartHtml = `
      <div style="margin:22px 0;padding:18px;border:1px solid #f6c84e;border-radius:8px;background:#fff9e8;">
        ...
        <p style="margin:16px 0 0;">
          ...
          <a href="${escapeHtml(plansUrl)}" style="display:inline-block;margin:0 8px 8px 0;background:#f6c84e;color:#111827;text-decoration:none;font-weight:800;padding:12px 16px;border-radius:8px;">View Coaching Plans</a>
