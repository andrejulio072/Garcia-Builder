-- Garcia Builder - Newsletter & Lead Generation Database Schema (FIXED VERSION)
...
-- RLS Policies for leads (simplified - allow read/write for now)
...
-- RLS Policies for email sends
CREATE POLICY "Allow all operations on email_sends" ON email_sends FOR ALL USING (true);
