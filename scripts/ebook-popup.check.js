...
const requiredSnippets = [
  ...
  ['separate optional marketing checkbox', 'name="marketingConsent"'],
  ...
  ['name and consent choices passed to ebook email', 'sendDownloadLink({ firstName, lastName, name, email, goal, consent, marketingConsent }, leadResponse)'],
