...
-- Perfil operacional usado pela área do usuário no frontend
-- ==========================================
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        CREATE POLICY "User can insert own user_profiles" ON public.user_profiles
            FOR INSERT
            TO authenticated
...
BEGIN
    ...
    VALUES (
        ...
        NULLIF(COALESCE(NEW.raw_user_meta_data->>'birthday', NEW.raw_user_meta_data->>'date_of_birth'), '')::date,
